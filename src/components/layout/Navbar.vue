...
<template>
  <header class="sticky top-0 z-50 w-full bg-white shadow-md rounded-md">
    ...
    <div class="flex items-center justify-between p-4">
      ...
      <div class="relative">
        <button @click="toggleDropdown" class="relative w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center text-white font-medium">
          <span>{{ user.initials }}</span>
        </button>

        <!-- Dropdown Menu (Profile Info and Options) -->
        <div v-show="isDropdownOpen" class="absolute right-0 mt-2 w-56 bg-white shadow-md rounded-md">
          <div class="p-3">
        ...
        <a @click="" class="flex items-center gap-3 px-4 py-2 text-sm text-red-500 hover:bg-gray-100">
